...
class Dungeon:
    ...
    def Init(self):
        ...
        self.room["1-branching"] = Room("1-branching",
                                        ...
                                        "Oh hi there, traveller! I'm one of the ghosts in this dungeon. I will guide you through it and try to help you through Your Journey! *smiles* \n "
                                        "Actually, no... I can't do that. Let's be honest now, I will try to kill you, or help you, who knows. \n "
                                        "Your choice is your death or life from now on. So, let's begin! *evil laugh* \n ",
